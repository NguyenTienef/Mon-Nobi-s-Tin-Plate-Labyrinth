...
def main():
    print("=" * 50)
    print("     DTC XML GENERATOR - RAISE DTC ONLY          ")
    print("=" * 50)

    input_xml = r"./input/ReadDTC_input.xml"
    output_xml = r"./output/ReadDTC_update.xml"

    if os.path.exists(output_xml):
        input_xml = output_xml
        print(f"\n[INFO] Continue from existing output: {output_xml}")
    elif not os.path.exists(input_xml):
        print(f"\n[ERROR] Template file không tồn tại: {input_xml}")
        sys.exit(1)
